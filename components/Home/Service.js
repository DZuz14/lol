...
<div className={classNames('text-center', styles.socialIcons)}>
        <div className="row">
          <div class="d-flex justify-content-center">
            <div className="p-4">
              {" "}
              <img src="/img/partner.png" alt="partner" height={30}></img>{" "}
            </div>
            <div className="p-4">
              {" "}
              <img src="/img/partner.png" alt="partner" height={30}></img>{" "}
        ...
        <div className="row">
          <div className="text-center">
            <div className="pt-5 pb-3 link-secondary"> <img className="pb-1" style={{ marginRight: 5 }} src="/img/ellipse.svg" /> Our services </div>
        ...
        <div className="row">
          ...
          <div className="col-md-3">
          {/* Get back to this, add lastCard. */}
            <div className={classNames(styles.serviceCard, styles.lastCard)} >
